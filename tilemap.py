...
#this grabs "map.txt" and makes python interpret it as an actual map
import pygame
...
class Map:
    ...
    def __init__(self, filename):
        ...
        #determines tile width and height, and determines the map size
